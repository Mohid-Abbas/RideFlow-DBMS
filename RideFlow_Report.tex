...
\begin{titlepage}
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \node at ([yshift=-1.5cm]current page.north) {\includegraphics[width=3cm]{images/fast_logo.png}};
    \end{tikzpicture}
...
\hline
4 & Login Page & images/login\_page.png \\
\hline
5 & Rider Dashboard & images/rider\_dashboard.png \\
\hline
6 & Book with Maps & images/book\_with\_maps.png \\
\hline
7 & Driver Dashboard & images/driver\_dashboard.png \\
\hline
8 & Admin Dashboard & images/admin\_dashboard.png \\
\hline
9 & User Management & images/admin\_users.png \\
\hline
10 & Fare Calculation & images/fare\_calculation.png \\
\hline
11 & Active Rides & images/active\_rides.png \\
\hline
\end{tabular}
\end{table}
